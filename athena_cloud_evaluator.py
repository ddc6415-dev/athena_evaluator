            ...
            try:
                ...
                payload = {
                    "contents": [{"parts": [{"text": (
                        ...
                        f"TASK 3 (Metrics): Provide the score for all six axes using proportional Unicode blocks out of 10 (e.g., [██████░░░░]). You MUST wrap this section in a markdown code block ({fence}text) and pad the labels with spaces so the left brackets align perfectly vertically. Format exactly like this:\n"
                        f"{fence}text\n"
                        f"Repeatability:            [██████░░░░]\n"
